  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="height: 38px; width: 100px; margin-left: 3px;" @click="getVerifyCode">获取验证码</button>
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
    ...
    methods: {
      async getVerifyCode(){
        try {
          ...
          this.code = this.$store.state.register.verifyCode
        } catch (error) {
          console.log(error);
        }
      },
      async registerUser(){
        ...
        try {
          phone && password && password === password1 && code &&
