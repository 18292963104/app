        ...
        >
          ...
          <li class="cart-list-con5">
            <a
              ...
              class="mins"
              @click="handkeSkuNum('mins', -1, cart)"
              >-</a
            >
            <input
              autocomplete="off"
              ...
              :value="cart.skuNum"
              class="itxt"
              @change="handkeSkuNum('change', $event.target.value, cart)"
            />
            <a
              href="javascript:void(0)"
              class="plus"
              @click="handkeSkuNum('add', 1, cart)"
              >+</a
            >
          </li>
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deletaSku(cart.skuId)">删除</a>
            <br />
            <a href="#none">移到收藏</a>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    handkeSkuNum: throttle(async function(type, num, cart) {
      switch (type) {
        case "mins":
